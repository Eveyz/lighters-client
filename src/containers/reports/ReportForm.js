      ...
      <div>
        ...
        <div className="row no-margin">
          <FormSelect
            ...
            action={action}
            prompt="请选择上课情况"
            options={["正常上课", "学员开课前2小时内才请假(0.5个课时费)", "学员上课时间后才请假或无故缺课(1个课时费)", "学员迟到(不必补全课时, 可按时下课, 1个课时费)", "老师迟到早退10分钟以内(需免费于当堂或下堂课补全课时才可得1个课时费, 但会影响薪资晋级)", "老师无故迟到10分钟以上20分钟以内并且课程依旧进行(0.5个课时费)", "老师无故迟到并且取消课程(0个课时费, 需免费补课一节)", "免费补课(0个课时费)", "试课"]}
