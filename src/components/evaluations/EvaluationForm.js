				...
				<div>
					<div className='row'>
						<div className="col input-field s4">
							<input type="date" defaultValue={getLocalDateFormat(props.evaluation.date) || ""} ref={dateInput} id="date" />
							<label htmlFor="date">评测日期</label>
						</div>
						<div className="col input-field s4">
							<input type="text" defaultValue={props.evaluation.level || ""} ref={levelInput} id="level" />
					...
					<FormTextarea
						...
						action={props.action}
						value={props.action === "EDIT" ? props.evaluation.content : ""}
					/>
